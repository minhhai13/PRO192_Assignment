...
public class TeaPot extends Item {
    ...
    public TeaPot(String id, String name, String category, String material, int inPrice,
            int price, double volume, List<String> authorIds, int yearOfRelease,
    ...
    // Returns a formatted string representation of the TeaPot object
    @Override
    ...
    // Input method to receive values for the TeaPot properties
    @Override
    public void input() {
    ...
    // Output method to display the TeaPot details
    @Override
    public void output() {
